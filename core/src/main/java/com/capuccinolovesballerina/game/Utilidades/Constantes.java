...
public class Constantes {
    ...
    public static final float ANCHO_MUNDO = 1408;
    public static final float ALTO_MUNDO = 768;
    public static final String RUTA_SKIN = "skin/uiskin.json";

    public static final float ANCHO_PERSONAJE = 48f;
